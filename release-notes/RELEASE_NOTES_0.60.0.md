...
Status: implementation checks passed; cumulative pentest pending.
Publication: PENDING

## Public Checkpoint

This release publishes the complete v0.55.0-to-v0.60.0 delta. Intermediate
signed tags and reports remain evidence, but do not replace the cumulative
integration pentest required for this checkpoint.
...
Finish local implementation checks, request cumulative pentest of the exact
candidate against v0.55.0, remediate and retest findings, then record the real
