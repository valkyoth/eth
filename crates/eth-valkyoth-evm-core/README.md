...
write protection, return-data ranges, and journal checkpoint policy. Bytecode
input is capped at the EIP-170 code-size
...
- No nested call/create execution, log, precompile, refund, or committed
