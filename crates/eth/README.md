...
The crate is intentionally conservative at `0.27.0`: it provides explicit
...
descriptors, an opt-in bounded JSON typed-data parser, an opt-in reviewed
...
```toml
[dependencies]
eth = { version = "0.27", default-features = false }
```
