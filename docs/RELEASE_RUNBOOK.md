...
5. Run repository and version-specific implementation checks, then explicitly
   stop and ask the maintainer to pentest. For v0.57.0, use
   `scripts/release_0_57_0_gate.sh --implementation`; no final report is needed.
...
9. When the maintainer confirms GitHub is green and explicitly asks to tag and
   ...
   annotated tag. For v0.57.0, `scripts/release_0_57_0_gate.sh` (or `--tag`)
