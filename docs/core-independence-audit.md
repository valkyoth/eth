...
| `v0.177.0..=v0.178.1` | Add Kani proof harnesses as extra assurance for selected codec, primitive, evidence-capability conservation, typestate, EVM, trie, state, and cryptographic arithmetic invariants. |
