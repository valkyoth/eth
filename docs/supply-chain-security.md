...
log ceiling. Runs use high-entropy names, start containers only after capturing
their immutable IDs, and verify removal of every owned container and network.
