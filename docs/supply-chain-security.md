...
| `quote` | `1.0.45` | `MIT OR Apache-2.0` | enabled | Code generation for optional derive macros. |
| `libfuzzer-sys` | `0.4.13` | `(MIT OR Apache-2.0) AND NCSA` | fuzz-only | LLVM libFuzzer runtime for `fuzz/` targets. |
| `sanitization` | `1.1.1` | `MIT OR Apache-2.0` | disabled | Optional best-effort secret memory clearing bridge. |
