...
`v0.41.0` adds the first bounded native execution pass for basic
stack/control-flow bytecode, without admitting a concrete production execution
backend.
