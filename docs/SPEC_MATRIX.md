...
| Blob/KZG validation | scheduled | `v0.61.0` through `v0.61.5` schedule first-party trusted-setup handling, KZG field/polynomial arithmetic, commitment/proof verification, point-evaluation execution, blob versioned-hash validation, count and fee accounting, fork integration, and official fixture coverage. |
