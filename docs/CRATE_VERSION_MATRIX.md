...
| --- | --- | --- | --- | --- | --- |
| `eth-valkyoth-codec` | `0.16.0` | `0.16.0` | `unchanged` | No | No package changes for v0.22.0. |
| `eth-valkyoth-primitives` | `0.10.1` | `0.10.1` | `unchanged` | No | No package changes for v0.22.0. |
| `eth-valkyoth-hash` | `0.10.0` | `0.10.0` | `unchanged` | No | No package changes for v0.22.0. |
| `eth-valkyoth-protocol` | `0.18.0` | `0.19.0` | `code` | Yes | Adds canonical transaction signing-preimage encoders for legacy EIP-155, EIP-2930, EIP-1559, and EIP-4844. |
| `eth-valkyoth-verify` | `0.10.0` | `0.11.0` | `code` | Yes | Adds typed transaction signing-hash helpers behind the caller-provided Keccak-256 boundary. |
| `eth-valkyoth-derive` | `0.16.1` | `0.16.1` | `unchanged` | No | No package changes for v0.22.0. |
| `eth-valkyoth-sanitization` | `0.7.1` | `0.7.1` | `unchanged` | No | No package changes for v0.22.0. |
| `eth-valkyoth-evm` | `0.7.0` | `0.7.0` | `unchanged` | No | No package changes for v0.22.0. |
| `eth-valkyoth-rpc` | `0.7.0` | `0.7.0` | `unchanged` | No | No package changes for v0.22.0. |
| `eth-valkyoth-signer` | `0.7.0` | `0.7.0` | `unchanged` | No | No package changes for v0.22.0. |
| `eth-valkyoth-reth` | `0.7.0` | `0.7.0` | `unchanged` | No | No package changes for v0.22.0. |
| `eth-valkyoth-testkit` | `0.7.0` | `0.7.0` | `unchanged` | No | No package changes for v0.22.0. |
| `eth` | `0.21.0` | `0.22.0` | `code` | Yes | Re-exports the v0.22.0 transaction signing-hash APIs and packaged documentation. |
