...
| --- | --- | --- | --- | --- | --- |
| `eth-valkyoth-codec` | `0.17.0` | `0.17.0` | `unchanged` | No | No package changes for v0.29.0. |
| `eth-valkyoth-primitives` | `0.11.0` | `0.11.0` | `unchanged` | No | No package changes for v0.29.0. |
| `eth-valkyoth-hash` | `0.11.0` | `0.11.0` | `unchanged` | No | No package changes for v0.29.0. |
| `eth-valkyoth-protocol` | `0.23.0` | `0.24.0` | `code` | Yes | Adds syntactic legacy and typed receipt decoding with borrowed logs and fuzz coverage. |
| `eth-valkyoth-verify` | `0.17.1` | `0.17.2` | `dependency` | Yes | Bumps the published protocol dependency range to `eth-valkyoth-protocol 0.24.0`. |
| `eth-valkyoth-derive` | `0.17.0` | `0.17.0` | `unchanged` | No | No package changes for v0.29.0. |
| `eth-valkyoth-sanitization` | `0.7.2` | `0.7.2` | `unchanged` | No | No package changes for v0.29.0. |
| `eth-valkyoth-evm` | `0.7.0` | `0.7.0` | `unchanged` | No | No package changes for v0.29.0. |
| `eth-valkyoth-rpc` | `0.7.0` | `0.7.0` | `unchanged` | No | No package changes for v0.29.0. |
| `eth-valkyoth-signer` | `0.7.1` | `0.7.1` | `unchanged` | No | No package changes for v0.29.0. |
| `eth-valkyoth-reth` | `0.7.0` | `0.7.0` | `unchanged` | No | No package changes for v0.29.0. |
| `eth-valkyoth-testkit` | `0.7.0` | `0.7.0` | `unchanged` | No | No package changes for v0.29.0. |
| `eth` | `0.28.0` | `0.29.0` | `code` | Yes | Re-exports the new receipt decode APIs and updates packaged documentation. |
