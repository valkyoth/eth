...
| --- | --- | --- | --- | --- | --- |
| `eth-valkyoth-codec` | `0.19.0` | `0.20.0` | `code` | Yes | Public shared decode-session policy, ledger, and RLP APIs. |
...
| `eth-valkyoth-protocol` | `0.25.2` | `0.26.0` | `code` | Yes | Public shared-session transaction APIs. |
| `eth-valkyoth-verify` | `0.23.0` | `0.24.0` | `code` | Yes | Public shared-session MPT syntax APIs. |
