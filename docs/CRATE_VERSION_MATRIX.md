...
| `eth-valkyoth-evm-core` | `0.29.0` | `0.29.0` | `code` | No | Adds public-input BLS12-381 Fp/Fp2/G1 arithmetic and charged G1 addition; cumulative bump at v0.60.0. |
...
| `eth` | `0.55.0` | `0.59.0` | `code` | No | Internal facade milestone for BLS12-381 Fp2 arithmetic; no publication before v0.60.0. |
