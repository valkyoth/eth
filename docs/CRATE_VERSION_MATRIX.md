...
## v0.26.1 Tracking Table

| Crate | Published | Planned | Change | Publish | Reason |
| --- | --- | --- | --- | --- | --- |
| `eth-valkyoth-codec` | `0.17.0` | `0.17.0` | `unchanged` | No | No package changes for v0.26.1. |
| `eth-valkyoth-primitives` | `0.11.0` | `0.11.0` | `unchanged` | No | No package changes for v0.26.1. |
| `eth-valkyoth-hash` | `0.10.1` | `0.10.1` | `unchanged` | No | No package changes for v0.26.1. |
| `eth-valkyoth-protocol` | `0.22.1` | `0.22.1` | `unchanged` | No | No package changes for v0.26.1. |
| `eth-valkyoth-verify` | `0.15.0` | `0.16.0` | `code` | Yes | Adds the optional bounded EIP-712 JSON typed-data parser boundary. |
| `eth-valkyoth-derive` | `0.17.0` | `0.17.0` | `unchanged` | No | No package changes for v0.26.1. |
| `eth-valkyoth-sanitization` | `0.7.2` | `0.7.2` | `unchanged` | No | No package changes for v0.26.1. |
| `eth-valkyoth-evm` | `0.7.0` | `0.7.0` | `unchanged` | No | No package changes for v0.26.1. |
| `eth-valkyoth-rpc` | `0.7.0` | `0.7.0` | `unchanged` | No | No package changes for v0.26.1. |
| `eth-valkyoth-signer` | `0.7.1` | `0.7.1` | `unchanged` | No | No package changes for v0.26.1. |
| `eth-valkyoth-reth` | `0.7.0` | `0.7.0` | `unchanged` | No | No package changes for v0.26.1. |
| `eth-valkyoth-testkit` | `0.7.0` | `0.7.0` | `unchanged` | No | No package changes for v0.26.1. |
| `eth` | `0.26.0` | `0.26.1` | `code` | Yes | Adds the opt-in `eip712-json` feature and updates packaged documentation. |
