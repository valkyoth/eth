...
| `eth-valkyoth-verify` | `0.22.0` | `0.23.0` | `code` | Yes | Hardens EIP-712 identifiers, reserved names, duplicate and resource limits, and partial encode-data output handling. |
