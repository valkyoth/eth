...
Status: `v0.48.0` adds bounded native ModExp precompile execution.
...
dependency-free identity, SHA-256, RIPEMD-160, and bounded ModExp execution,
and ECRECOVER execution through explicit caller-provided secp256k1 and Keccak
...
| --- | --- | --- | --- | --- | --- |
| `eth-valkyoth-codec` | `0.19.0` | `0.19.0` | `unchanged` | No | No package changes for v0.48.0. |
| `eth-valkyoth-primitives` | `0.11.2` | `0.11.2` | `unchanged` | No | No package changes for v0.48.0. |
| `eth-valkyoth-hash` | `0.11.2` | `0.11.2` | `unchanged` | No | No package changes for v0.48.0. |
| `eth-valkyoth-protocol` | `0.25.2` | `0.25.2` | `unchanged` | No | No package changes for v0.48.0. |
| `eth-valkyoth-verify` | `0.21.0` | `0.21.0` | `unchanged` | No | No package changes for v0.48.0. |
| `eth-valkyoth-derive` | `0.17.2` | `0.17.2` | `unchanged` | No | No package changes for v0.48.0. |
| `eth-valkyoth-sanitization` | `0.7.4` | `0.7.4` | `unchanged` | No | No package changes for v0.48.0. |
| `eth-valkyoth-evm-core` | `0.10.0` | `0.11.0` | `code` | Yes | Adds bounded first-party ModExp precompile parsing, fork-aware gas, execution, and fuzz coverage. |
| `eth-valkyoth-evm` | `0.10.0` | `0.10.0` | `unchanged` | No | No package changes for v0.48.0. |
| `eth-valkyoth-rpc` | `0.7.0` | `0.7.0` | `unchanged` | No | No package changes for v0.48.0. |
| `eth-valkyoth-signer` | `0.7.3` | `0.7.3` | `unchanged` | No | No package changes for v0.48.0. |
| `eth-valkyoth-reth` | `0.7.0` | `0.7.0` | `unchanged` | No | No package changes for v0.48.0. |
| `eth-valkyoth-testkit` | `0.7.0` | `0.7.0` | `unchanged` | No | No package changes for v0.48.0. |
| `eth` | `0.47.0` | `0.48.0` | `code` | Yes | Updates the optional `evm-core` dependency to `eth-valkyoth-evm-core 0.11.0` and documents bounded native ModExp execution. |
