...
and BN254 pairing empty-input plus G2 subgroup validation and Fp6/Fp12 tower
arithmetic, and ECRECOVER execution through explicit caller-provided
...
## v0.50.2 Tracking Table

| Crate | Published | Planned | Change | Publish | Reason |
| --- | --- | --- | --- | --- | --- |
| `eth-valkyoth-codec` | `0.19.0` | `0.19.0` | `unchanged` | No | No package changes for v0.50.2. |
| `eth-valkyoth-primitives` | `0.11.2` | `0.11.2` | `unchanged` | No | No package changes for v0.50.2. |
| `eth-valkyoth-hash` | `0.11.2` | `0.11.2` | `unchanged` | No | No package changes for v0.50.2. |
| `eth-valkyoth-protocol` | `0.25.2` | `0.25.2` | `unchanged` | No | No package changes for v0.50.2. |
...
| `eth-valkyoth-reth` | `0.7.0` | `0.7.0` | `unchanged` | No | No package changes for v0.50.2. |
| `eth-valkyoth-testkit` | `0.7.0` | `0.7.0` | `unchanged` | No | No package changes for v0.50.2. |
| `eth` | `0.50.1` | `0.50.2` | `code` | Yes | Updates the optional `evm-core` dependency to `eth-valkyoth-evm-core 0.15.0` and documents the BN254 Fp6/Fp12 tower foundation. |
