...
| --- | --- | --- | --- | --- | --- |
| `eth-valkyoth-codec` | `0.16.0` | `0.16.0` | `unchanged` | No | No package changes for v0.24.0. |
| `eth-valkyoth-primitives` | `0.10.1` | `0.10.1` | `unchanged` | No | No package changes for v0.24.0. |
| `eth-valkyoth-hash` | `0.10.0` | `0.10.0` | `unchanged` | No | No package changes for v0.24.0. |
| `eth-valkyoth-protocol` | `0.19.0` | `0.20.0` | `code` | Yes | Adds EIP-7702 set-code transaction decode and encode helpers. |
| `eth-valkyoth-verify` | `0.12.0` | `0.13.0` | `code` | Yes | Adds set-code replay-domain support and fail-closed signature validation handling for unsupported set-code signatures. |
| `eth-valkyoth-derive` | `0.16.1` | `0.16.1` | `unchanged` | No | No package changes for v0.24.0. |
| `eth-valkyoth-sanitization` | `0.7.1` | `0.7.1` | `unchanged` | No | No package changes for v0.24.0. |
| `eth-valkyoth-evm` | `0.7.0` | `0.7.0` | `unchanged` | No | No package changes for v0.24.0. |
| `eth-valkyoth-rpc` | `0.7.0` | `0.7.0` | `unchanged` | No | No package changes for v0.24.0. |
| `eth-valkyoth-signer` | `0.7.0` | `0.7.0` | `unchanged` | No | No package changes for v0.24.0. |
| `eth-valkyoth-reth` | `0.7.0` | `0.7.0` | `unchanged` | No | No package changes for v0.24.0. |
| `eth-valkyoth-testkit` | `0.7.0` | `0.7.0` | `unchanged` | No | No package changes for v0.24.0. |
| `eth` | `0.23.0` | `0.24.0` | `code` | Yes | Re-exports EIP-7702 set-code transaction decode and encode APIs and packaged documentation. |
