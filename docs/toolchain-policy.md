...
`eth` pins stable Rust `1.97.0` in `rust-toolchain.toml` and supports Rust
`1.90.0` through `1.97.0`.
...
The full release gate runs under the pinned Rust `1.97.0` toolchain.
