...
```toml
[dependencies]
eth = { version = "0.43.0", features = ["sanitization"] }
```
...
```toml
[dependencies]
eth = { version = "0.43.0", features = ["keccak-tiny"] }
```
...
```toml
[dependencies]
eth = { version = "0.43.0", features = ["secp256k1-k256"] }
```
...
```toml
[dependencies]
eth = { version = "0.43.0", features = ["evm"] }
```
