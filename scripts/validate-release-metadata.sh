...
test -f release-notes/RELEASE_NOTES_0.43.0.md
test -f release-notes/RELEASE_NOTES_0.43.1.md
test -f release-notes/RELEASE_NOTES_0.43.2.md
test -f release-notes/RELEASE_NOTES_0.44.0.md
test -f release-notes/RELEASE_NOTES_0.45.0.md
test -f release-notes/RELEASE_NOTES_0.46.0.md
test -f release-notes/RELEASE_NOTES_0.47.0.md
test -f release-notes/RELEASE_NOTES_0.48.0.md
test -f release-notes/RELEASE_NOTES_0.49.0.md
test -f release-notes/RELEASE_NOTES_0.50.0.md
test -f release-notes/RELEASE_NOTES_0.50.1.md
test -f release-notes/RELEASE_NOTES_0.50.2.md
test -f release-notes/RELEASE_NOTES_0.50.3.md
test -f release-notes/RELEASE_NOTES_0.50.4.md
test -f release-notes/RELEASE_NOTES_0.50.5.md
test -f release-notes/RELEASE_NOTES_0.50.6.md
test -f release-notes/RELEASE_NOTES_0.50.7.md
test -f release-notes/RELEASE_NOTES_0.50.8.md
...
test -f release-notes/RELEASE_NOTES_0.52.1.md
test -f release-notes/RELEASE_NOTES_0.52.2.md
test -f release-notes/RELEASE_NOTES_0.52.3.md
test -f release-notes/RELEASE_NOTES_0.52.4.md
test -f release-notes/RELEASE_NOTES_0.52.5.md
...
test -f release-notes/RELEASE_NOTES_0.55.0.md
...
test -x scripts/release_0_42_gate.sh
test -x scripts/release_0_43_gate.sh
test -x scripts/release_0_43_1_gate.sh
test -x scripts/release_0_43_2_gate.sh
test -x scripts/release_0_44_gate.sh
test -x scripts/release_0_45_gate.sh
test -x scripts/release_0_46_gate.sh
test -x scripts/release_0_47_gate.sh
test -x scripts/release_0_48_gate.sh
test -x scripts/release_0_49_gate.sh
test -x scripts/release_0_50_gate.sh
test -x scripts/release_0_50_1_gate.sh
test -x scripts/release_0_50_2_gate.sh
test -x scripts/release_0_50_3_gate.sh
test -x scripts/release_0_50_4_gate.sh
test -x scripts/release_0_50_5_gate.sh
test -x scripts/release_0_50_6_gate.sh
test -x scripts/release_0_50_7_gate.sh
test -x scripts/release_0_50_8_gate.sh
...
test -x scripts/release_0_52_2_gate.sh
grep -q "rustc 1\\\\.97\\\\.1" scripts/release_0_52_2_gate.sh
test -x scripts/release_0_52_3_gate.sh
grep -q "rustc 1\\\\.97\\\\.1" scripts/release_0_52_3_gate.sh
test -x scripts/release_0_52_4_gate.sh
...
test -x scripts/release_0_52_6_gate.sh
grep -q "rustc 1\\\\.97\\\\.1" scripts/release_0_52_6_gate.sh
test -x scripts/release_0_52_7_gate.sh
...
test -f docs/execution-admission-host.md
test -f docs/bn254-pairing-economics.md
test -f docs/advanced-precompile-backends.md
test -f docs/bls12-381-wire-encodings.md
test -f docs/truncated-push-semantics.md
test -f docs/execution-resource-governor.md
test -f docs/modexp-precompile.md
