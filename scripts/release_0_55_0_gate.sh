...
mkdir -p target
cargo tree -p eth -e normal > target/release_0_55_0_default_runtime_tree.txt
cargo tree -p eth -e features --all-features > target/release_0_55_0_all_features_tree.txt
