...
case "${1:---tag}" in
    --tag)
        ...
        scripts/validate-release-readiness.sh v0.58.0
        exit 0
        ;;
    --implementation) ;;
    *)
...
cargo test -p eth-valkyoth-evm-core --release --test bls12_field_differential --test bls12_g1_differential --test bls12_g1_vectors --test bls12_g1_rejections
